...
class FaceRecognitionLauncher:
    ...
    def setup_ui(self):
        ...
        # Register New Student button (moved to student manager)
        register_btn = tk.Button(options_frame, text="👤 Register New Student", 
                                command=self.run_register_student,
                                height=button_height, width=button_width, 
                                bg="#FF9800", fg="white")
    ...
    def run_register_student(self):
        """Run face data collection mode through student manager"""
        try:
            # Open student manager directly to add screen
